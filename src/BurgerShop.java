   ...
   // public static Order[] order = new Order[0];
    ...
    public static void placeOrder() {
        ...
        L1: do {
            ...
            for (int i = 0; i < list.size(); i++) {
                if (customerId.equals(list.get(i).getPhone())) {
            ...
            if (qty > 0) {
                ...
                do {
                    ...
                    if (option.equalsIgnoreCase("Y")) {
                        list.add(new Order(customerName, orderId, qty, customerId, billValue,PREPARING));
    ...
    public static void searchBestCustomer() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int j = 0; j < sortOrder.length; j++) {
                if (sortOrder[j].getPhone().equals(list.get(i).getPhone())) {
                    if (list.get(i).getStatus()!=CANCEL){
                        sortOrder[j].setTotal(sortOrder[j].getTotal()+list.get(i).getTotal());
                    }
                    isExist = true;
                }
            }
            if (!isExist) {
                ...
                sortOrder = tempSort;
                sortOrder[sortOrder.length-1] = new Order(list.get(i).getCustomerName(),list.get(i).getOrderID(),list.get(i).getBurgerQty(),list.get(i).getPhone(),list.get(i).getTotal(),list.get(i).getStatus());
            }
        }
        // sort
            ...
            for (int i = 0; i < list.size(); i++) {
                if (orderId.equals(list.get(i).getOrderID())) {
                    ...
                    String line = String.format("%1s%-10s%-14s%-15s%-10d%-14.2f%-10s", " ", list.get(i).getOrderID(),
                            list.get(i).getPhone(), list.get(i).getCustomerName(), list.get(i).getBurgerQty(), list.get(i).getTotal(), status);
    ...
    public static void searchCustomer() {
        ...
        L1: do {
            ...
            for (int i = 0; i < list.size(); i++) {
                if (customerId.equals(list.get(i).getPhone())) {
                    System.out.println("CustomerID - " + list.get(i).getPhone());
                    ...
                    for (int j = 0; j < list.size(); j++) {
                        if (list.get(j).getPhone().equals(customerId)) {
                            String line2 = String.format("%1s%-12s%-18d%-14.2f", " ", list.get(j).getOrderID(),list.get(j).getBurgerQty(),
                                    list.get(j).getTotal());
    ...
    public static void deliverOrder() {
        ...
        System.out.println("--------------------------------------------------------------");
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).getStatus() == DELIVERED) {
                String line = String.format("%1s%-10s%-15s%-15s%-10d%8.2f", " ", list.get(i).getOrderID(), list.get(i).getPhone(),
                        list.get(i).getCustomerName(),list.get(i).getBurgerQty(), list.get(i).getTotal());
                System.out.println(line);
                System.out.println("--------------------------------------------------------------");
            }
        }
    ...
    public static void preparingOrder() {
        ...
        System.out.println("--------------------------------------------------------------");
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).getStatus() == PREPARING) {
                String line = String.format("%1s%-10s%-15s%-15s%-10d%8.2f", " ", list.get(i).getOrderID(), list.get(i).getPhone(),
                        list.get(i).getCustomerName(),list.get(i).getBurgerQty(), list.get(i).getTotal());
                System.out.println(line);
                System.out.println("--------------------------------------------------------------");
            ...
            for (int i = 0; i < list.size(); i++) {
                if (orderId.equals(list.get(i).getOrderID())) {
                    ...
                    if (status == "Cancel") {
                        ...
                        System.out.println("CustomerID - " + list.get(i).getPhone());
                        System.out.println("Name       - " + list.get(i).getCustomerName());
                        System.out.println("Quantity   - " + list.get(i).getBurgerQty());
                        System.out.printf("OrderValue - %.2f", list.get(i).getTotal());
                        System.out.println("\nOrderStatus- " + status);
                        ...
                        switch (option) {
                            case 1:
                                ...
                                int qty = input.nextInt();
                                list.get(i).setBurgerQty(qty);
                                list.get(i).setTotal(qty*BURGERPRICE);
                                System.out.println("\n\tupdate order quantity success fully...");
                                System.out.println("\nnew order quantity - " + list.get(i).getBurgerQty());
                                System.out.printf("new order value - %.2f", list.get(i).getTotal());
                                break;
                            case 2:
                                clearConsole();
                                System.out.println("\nStatus Update");
